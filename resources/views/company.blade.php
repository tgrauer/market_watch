...
<div class="container company_profile">
    <div class="row">
        <div class="col-xl-12 mt50">
            ...
            <h3 class="current_stock_price">${{$company_profile['quote']['latestPrice']}} <span class="latest_change {{$company_profile['quote']['changePercent']* 100 >0 ? 'positive' : 'negative'}}">{{$company_profile['quote']['change']}} ({{round($company_profile['quote']['changePercent']* 100, 2)}}%) {!! $company_profile['quote']['changePercent']* 100 > 0 ? '<span class="positive"><i class="fa fa-arrow-up"></i></span>' : '<span class="negative"><i class="fa fa-arrow-down"></i></span>' !!}</span></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 company_details card">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">Volume {{$company_profile['quote']['volume']}}</li>
                                <li class="list-group-item">Average Volume {{$company_profile['quote']['avgTotalVolume']}}</li>
                                <li class="list-group-item">52 Week High ${{$company_profile['quote']['week52High']}}</li>
                                <li class="list-group-item">52 Week Low ${{$company_profile['quote']['week52Low']}}</li>
                            </ul>
                        </div>
                    </div>
                </div>

...
<div class="bg-light border-right" id="sidebar-wrapper">
    <div class="list-group list-group-flush">
        ...
        <a href="{{action('CompanyController@getCompanyDividends', [Session::get('ticker'), '1y'])}}" class="list-group-item list-group-item-action {{$page == 'company_dividends' ? 'active' : ''}}">Dividends</a>
